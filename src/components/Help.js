...
const Help = () => {
  return (
    <Jumbotron>
      <h3>About Surat Municipal Corporation (RMC)</h3>
      <span>
        Surat Municipal Corporation (RMC) is a local government committed to
      ...
      <div className="mt-5">
        ...
        <p>
          {' '}
          E-Mail:<a href="mailto:mc_rmc@yahoo.co.in"> mc_smc@smc.gov.in</a>{' '}
        </p>
        <p>
          {' '}
          Website:{' '}
          <a href="https://www.suratmunicipal.gov.in/">
            {' '}
            www.smc.gov.in
          </a>
        </p>
